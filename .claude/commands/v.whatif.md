# v.whatif — Evaluate an Idea Before Building

**Purpose**: Apply critical thinking to decide: proceed, defer, simplify, alternative, or skip.
...
## Result
- Clear verdict.
- If proceeding, plan updated with minimal actionable tasks.
