# Vibe-Coding Framework — CLAUDE.md (v2.1)
...
- **v.memorize** — Sync progress/changelog; rotate archives; keep live files slim.
...
Version: 2.1 (with v.initmemory and cross-links)
